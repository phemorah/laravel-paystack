...
namespace Phemorah\Paystack\Test;

use Mockery as m;
use GuzzleHttp\Client;
use PHPUnit_Framework_TestCase;
use Phemorah\Paystack\Paystack;
...
class PaystackTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->paystack = m::mock('Phemorah\Paystack\Paystack');
    ...
    {
        $array = $this->paystack->shouldReceive('getAllCustomers')->andReturn(['phemorah']);
